...
public class MerchantImpl implements MerchantService {
    ...
    public Map<Object, Object> save(Merchant request) {
        try {
            ...
            if (authentication != null && authentication.getDetails() instanceof OAuth2AuthenticationDetails) {
                ...
                authToken = details.getTokenValue();
            }

            if (!saveAuthorities(userId, object.getId(), authToken)) throw new TransactionSystemException("Failed to save user");
    ...
    private boolean saveAuthorities(Long userId, UUID merchantId, String authToken) {
